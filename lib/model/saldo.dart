class Saldo {
  ...
  return Saldo(
    ...
    userId: json['id_user'],
    totalPanen: (json['total_panen'] ?? 0).toDouble(), // Menghandle nilai null jika diperlukan
    pendapatan: (json['pendapatan'] ?? 0).toDouble(), // Menghandle nilai null jika diperlukan
